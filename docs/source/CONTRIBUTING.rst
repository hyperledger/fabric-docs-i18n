...
在我们参与之前，首先需要回顾 `行为准则 <https://wiki.hyperledger.org/community/hyperledger-project-code-of-conduct>`__
。保证文明合法是很重要的。

Ways to contribute-贡献的方法
------------------
...
- `Making Feature/Enhancement Proposals-提出功能/改进建议`_
- `Reporting bugs-反馈错误`_
...
Getting a Linux Foundation account-获取一个Linux Foundation的账号
----------------------------------
...
为了参与到Hyperledger Fabric项目的开发中来，你首先需要一个 :doc:`Linux Foundation的账号 <Gerrit/lf-account>` 。
...
Making Feature/Enhancement Proposals-提出功能/改进建议
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Reviewing submitted Change Requests (CRs)-审核提交的变更请求(CRs)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
