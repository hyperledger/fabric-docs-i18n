...
本主题介绍如何使用 Hyperledger Fabric 开发客户端应用程序和智能合约来解决业务问题。在现实世界的
**商业票据**场景中，涉及多个组织，你将了解实现此目标所需的所有概念和任务。我们假设区块链网络已经可用。
...
你可以选择按顺序阅读，也可以根据需要选择各个部分。各个部分是根据读者的相关性来进行标记的，所以
无论你是在寻找业务信息还是技术信息，都可以清楚地知道这个主题是否适合你。
...
该主题遵循典型的软件开发生命周期。它以业务需求开始，然后覆盖了为满足业务需求而开发一个应用
和智能合约所需要的所有主要的技术活动。
...
如果你愿意，通过运行商业票据 `教程 <../tutorial/commercial_paper.html>`_，按照简短的解释立即试用
商业票据场景。当你需要对本教程中介绍的概念进行更全面的解释时，可以返回此主题。
