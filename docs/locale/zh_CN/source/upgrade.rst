...
1. :doc:`upgrade_to_newest_version`. 本主题讨论从以前的版本以及从最近的长期支持（LTS）版本获取最新版本的重要注意事项。
2. :doc:`upgrading_your_components`. 在更新任何功能之前，应将组件升级到最新版本。
3. :doc:`updating_capabilities`. 在更新所有节点的版本后完成。
4. :doc:`enable_cc_lifecycle`. 需要将组织的特定背书策略中心添加到Fabric v2.x的新链码生命周期。
