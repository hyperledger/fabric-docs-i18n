...
**"Fabric", "Hyperledger Fabric" 或 "HLF"?**

第一次使用应该是“Hyperledger Fabric”，之后只使用“Fabric”。不要单独使用“HLF”或“Hyperledger”。
...
通俗地说，智能合约被视为等同于链码，但在技术层面上，更正确的说法是“Smart contract（智能合约）”是链码内部的业务逻辑，它包含更大的打包和实现。
...
别太常用就行。最好的用法是作为一个总结，或者作为一种方式，提醒读者注意你想谈论的概念。“区块链网络包含一个账本、至少一个链码和对等方”，尤其是如果你要在那一段中谈论这些事情。避免仅仅为了强调一个词而使用它们，比如“区块链网络**必须**使用适当的安全协议”。
...
连字符通常用作“复合形容词”的一部分。例如，“喷气式-汽车（jet-powered car）”。注意复合形容词必须紧跟在被修饰名词之前。换句话说，“喷气式”本身不需要连字符。如果有疑问，可以使用Google，因为复合形容词很棘手，而且是语法讨论板上的热门讨论。
...
数字0到9都是拼写出来的。一、二、三、四等。10后的数字表示为数字。
...
经典例子是, “我想感谢我的父母，安·兰德和上帝”, 更应该写成: “我想感谢我的父母，安·兰德，和上帝”
...
通常，将每个命令放在自己的代码段中。它读起来更好，尤其是当命令很长的时候。除了解释一大串环境变量的时候。
