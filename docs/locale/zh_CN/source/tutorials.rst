...
你可以先在本地机器上部署 `测试网络 <./test_network.html>`_， 来开始使用 Fabric。
...
无论是网络运维还是应用开发人员，都可以通过 `私有数据 <./private_data_tutorial.html>`_ 和 `CouchDB <./couchdb_tutorial.html>`_ 教程来探索 Fabric 的重要功能。
...
.. note:: 如果本文档不能解决你的问题，或者在使用本教程的过程中遇到了其他问题，请阅读 :doc:`questions` 章节来寻求额外帮助。
